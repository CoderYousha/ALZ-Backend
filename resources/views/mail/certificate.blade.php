        ...
        <tr><!-- Outer Table -->
            <td align="center" bgcolor="#f0f0f0" data-composer>
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
                    ...
                    <!-- lotus-header-2 -->
                    <tr>
                        <td align="center" bgcolor="#214859" class="container-padding">
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" class="container-padding">
                                                    ...
                                                    <!-- column -->
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                        role="presentation" class="row" width="380"
                                                        style="width:380px;max-width:380px;">
                                                        <tr>
                                                            <td width="100" height="100" align="center"
                                                                class="center-text">
                                                                <img style="width:380px;border:0px;display: inline!important;"
                                                                src="{{ asset('assets/img/emails/logo.png') }}"
                                                                width="380" border="0"
                                                                alt="logo">
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        {{-- <div>
                                            {{ __('mail.verification.confirmation_code') }}
                                        </div> --}}
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:32px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <div>
                                            {{ __('mail.verification.ignore_this') }}
                                        </div>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <a href="mailto:{{ env('MAIL_FROM_ADDRESS') }}"
                                            style="color:#6e6e6e;"><span>{{ env('MAIL_FROM_ADDRESS') }}</span></a>
                                        - <a href="{{ url('/') }}"
